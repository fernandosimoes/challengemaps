...
class CustomMap extends Component {
    ...
    includeMarkers() {
        return lojas.stores.map((store, key)=>{
            if (store.revenue < this.state.minimalvalue) {
                return (
                <Marker 
                    key={key} 
    ...
    render() {
        console.log(this.state.errorvalue);
        ...
        return (
            <div className="mapcontent">
                <div className="faturamentominimo">
                    ...
                    <input type="text" className="minimal--value" onChange={this.changeMinimalValue} placeholder={this.state.minimalvalue}/>
...
const MapComponent = GoogleApiWrapper({ apiKey: '', LoadingContainer: LoadingContainer })(CustomMap)// used in a real render of this SPA. the other option CustomMap stand alone is used in the test with jest
